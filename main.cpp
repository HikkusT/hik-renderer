...
private:
    ...
    void cleanup() {
        ...
        // This should be moved to cleanupSwapChain
    ...
    bool isDeviceSuitable(VkPhysicalDevice device) {
        // TODO: change this to a score. Vk-tutorial covers this
    ...
    QueueFamilyIndices findQueueFamilies(VkPhysicalDevice device) {
        ...
        for (const auto& queueFamily : queueFamilies) {
            ...
            VkBool32 presentSurface = false;
            vkGetPhysicalDeviceSurfaceSupportKHR(device, i, surface, &presentSurface);
            if (presentSurface) {
    ...
    void createLogicalDevice() {
        // TODO: Understand a bit more about queue families
        ...
        // This is deprecated in modern implementations, adding for backwards compatibility
        if (enableValidationLayers) {
            createInfo.enabledLayerCount = static_cast<uint32_t>(validationLayers.size());
            createInfo.ppEnabledLayerNames = validationLayers.data();
        } else {
    ...
    void createSwapChain() {
        ...
        // TODO: Understand more about how multiple queues are actually handled
        QueueFamilyIndices indices = findQueueFamilies(physicalDevice);
        ...
        // Store swap chain handlers and info
    ...
    VkPresentModeKHR chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
        // TODO: Learn more about this. How this communication with monitor works?
    ...
    VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
        ...
        // TODO: Investigate what are those limits for the extent and who defines them (is it gpu or window limitation?)
    ...
    void createGraphicsPipeline() {
        ...
        auto attributeDescriptions = Vertex::getAttributesDescription();
        ...
        // TODO: Understand more about the second type of blending
    ...
    void createFramebuffers() {
        ...
        for (size_t i = 0; i < swapChainFramebuffers.size(); i++) {
            // TODO: remove this and directly reference from image views array
    ...
    void createCommandPool() {
        ...
        commandPoolInfo.flags = 0; // TODO: Understand more about those flags
    ...
    void createDescriptorSets() {
        // TODO: Understand more about descriptors
